...
|`useConnectionPlugins` | Boolean | No | Use connection plugins to execute JDBC methods. Set to false to disable this feature. **NOTE:** disabling connection plugins will also disable the failover functionality and Enhanced Failure Monitoring. | `true` |
...
The failover functionality is implemented by the Failover Connection Plugin. By default, Enhanced Failure Monitoring and the Failover Connection Plugin are loaded.
...
| Parameter       | Value           | Required      | Description  | Default Value |
| --------------- |:---------------:|:-------------:|:------------ | ------------- |
| `useConnectionPlugins` | Boolean | No | Disable connection plugins and execute JDBC methods directly. | `True` |
