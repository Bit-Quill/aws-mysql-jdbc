...
public class PropertyDefinitions {
    ...
    static {
        ...
        PropertyDefinition<?>[] pdefs = new PropertyDefinition<?>[] {
                ...
                new BooleanPropertyDefinition(PropertyKey.perfMetricAtClusterLevel, DEFAULT_VALUE_TRUE, RUNTIME_MODIFIABLE,
                    Messages.getString("ConnectionProperties.perfMetricAtClusterLevel"), "0.4.0", CATEGORY_HA, Integer.MAX_VALUE),
